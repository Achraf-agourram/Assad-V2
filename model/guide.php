...
class Guide extends User
{
    ...
    public function __construct(int $id, string $nom, string $email, string $role, string $motpasse, string $pays, string $created_at, int $approuveGuide, int $statutCompte)
    {
        $this->id = $id;
        $this->nom = $nom;
        $this->email = $email;
