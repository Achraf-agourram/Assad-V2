<?php
    ...
    $connectedUser = null;
    if(isset($_SESSION['loggedAccount'])) $connectedUser = User::findById($_SESSION['loggedAccount']);
    ...
    function navbar($links, $page){
        ...
        if($connectedUser){
            ...
            if($connectedUser->getRole() == 'admin'){
                echo "
                    <a href='{$links[3]}' class='bg-transparent border border-orange-700 text-orange-700 px-4 py-2 rounded-lg hover:bg-orange-500 hover:text-white transition duration-300'>
                        Admin
                    </a>
                ";
            }
    ...
    if(isset($_POST['login'])){
        $connectedUser = User::login($_POST['loginEmail'], $_POST['loginPassword']);
    ...
    if(isset($_POST['register'])){
        User::register($_POST['registerName'], $_POST['registerEmail'], $_POST['registerRole'], $_POST['registerPassword'], $_POST['registerCountry']);
